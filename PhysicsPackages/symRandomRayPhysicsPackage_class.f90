module symRandomRayPhysicsPackage_class
  ...
  !!   PP {
  !!     type symRandomRayPhysicsPackage;
  ...
  !!
  type, public, extends(physicsPackage) :: symRandomRayPhysicsPackage
    private
    ! Components
    ...
    real(defFlt), dimension(:), allocatable     :: mus
    real(defFlt), dimension(:), allocatable     :: phis
  ...
  contains
    ...
    procedure, private :: initialiseRayPtv
    procedure, private :: initialiseRayNtv
  ...
  end type symRandomRayPhysicsPackage
...
contains
  ...
  subroutine init(self,dict)
    class(symRandomRayPhysicsPackage), intent(inout) :: self
    ...
    character(100), parameter :: Here = 'init (symRandomRayPhysicsPackage_class.f90)'
    ...
    allocate(self % mus(self % pop / 2))
    allocate(self % phis(self % pop /2))
  ...
  subroutine cycles(self)
    ...
    do while( keepRunning )
      ...
      do i = 1, (self % pop/2)
        ...
        ! Set ray attributes
        call self % initialiseRayPtv(r,i)
      ...
      do i = 1, (self % pop/2)
        ...
        ! Set ray attributes
        call self % initialiseRayNtv(r,i)
  ...
  !!
  subroutine initialiseRayPtv(self, r, n)
    class(symRandomRayPhysicsPackage), intent(inout) :: self
    ...
    character(100), parameter :: Here = 'initialiseRay (symRandomRayPhysicsPackage_class.f90)'
  ...
  end subroutine initialiseRayPtv
  ...
  !! and performs the build operation
  !!
  subroutine initialiseRayNtv(self, r, n)
    class(symRandomRayPhysicsPackage), intent(inout) :: self
    type(ray), intent(inout)                      :: r
    integer(shortInt), intent(in)                 :: n
    real(defReal)                                 :: mu, phi
  ...
  end subroutine initialiseRayNtv
  ...
  subroutine transportSweep(self, r, ints)
    class(symRandomRayPhysicsPackage), target, intent(inout) :: self
    type(ray), intent(inout)                              :: r
  ...
  subroutine printSettings(self)
    class(symRandomRayPhysicsPackage), intent(in) :: self
...
end module symRandomRayPhysicsPackage_class
